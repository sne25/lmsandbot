...
<body>
    ...
    <div class="wrapper">
      ...
      ?>      </center> -->
            ...
            <li class="item">
                <a href="studentfrontpage.php?user_id=<?php echo $id ?>&department=<?php echo $dep ?>&semester=<?php echo $sem ?>" class="menu-btn">
        ...
        <div class="box-container">
            <div class="testbox">
                <form id="createform" method="post">
                    ...
                    <div class="item">
                        <p>Enter the semester that you want to access</p>
                    ...
                    <div class="item">
                        <p>Reason</p>
                        <input type="text" name="reason" id="reason" placeholder="year" required>
                    </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO arrear (name,registernumber,email,department,sem,reason) 
VALUES ('$name','$rrn','$email','$department','$sem','$reason')";
